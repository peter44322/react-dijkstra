      ...
      >
        ...
        <Modal.Content>
          <Modal.Description>
            ...
            <Header>
              If you want to add node type the name of the node (example f) and
            ...
            <Header>
              If you want to delete a node type the name of the node (example C
              ) and click on “delete” button.
            </Header>
            <Image wrapped fluid src="/steps/3.jpeg" />
            <Header>
              If you want to add an edge type the name of the source node
